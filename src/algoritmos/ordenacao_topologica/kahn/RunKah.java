...
public class RunKah {
    public static void main(String[] args) {
        ...
        System.out.println("--- TESTANDO ORDENAÇÃO TOPOLÓGICA EM UM DAG ---");
        ...
        if (dag != null) {
            Kahn<String> kahn = new Kahn<>(dag);
            ListaEncadeada<String> ordem = kahn.ordenar();
        ...
        System.out.println("--- TESTANDO DETECÇÃO DE CICLO ---");
        ...
        if (grafoComCiclo != null) {
            Kahn<String> kahnCiclo = new Kahn<>(grafoComCiclo);
            ListaEncadeada<String> ordemCiclo = kahnCiclo.ordenar();
